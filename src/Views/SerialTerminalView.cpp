...
void SerialTerminalView::welcome() {
    ...
    Serial.println("            |_|                              ");
    Serial.println();
    Serial.println("              C6 SLAVE INTERFACE");
    Serial.println();
    Serial.printf("     Version %s           Ready\n", version.c_str());
    Serial.println();
    Serial.println(" This device acts as a UART bridge to the ESP32-C6 slave firmware.");
    Serial.println(" All commands and output are provided directly by the C6.");
    Serial.println();
